...
See the [Installing SCST - Scan 2.0](./install-app-scanning.md) page.

## <a id="config-sa-reg-creds"></a> Configure Service Accounts and Registry Credentials

See the [Configure Service Accounts and Registry Credentials](./configure-sa-registry-creds.md)

## <a id="scan-image"></a> Scan an image

See the [Steps to scan an image](./scan-image.md)
