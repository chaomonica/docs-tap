...
1. Create your own `listing.json` file. To avoid compatibility issues between different Grype versions, include a database schema for each version. For example:
  ```json
    {
      "available": {
        "1": [
